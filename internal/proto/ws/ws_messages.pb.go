...
var file_proto_ws_messages_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_proto_ws_messages_proto_msgTypes = make([]protoimpl.MessageInfo, 48)
var file_proto_ws_messages_proto_goTypes = []any{
	...
	(*WsEnvelope)(nil),                 // 4: lightspeedduel.ws.WsEnvelope
	(*StateUpdate)(nil),                // 5: lightspeedduel.ws.StateUpdate
	(*RoomFullError)(nil),              // 6: lightspeedduel.ws.RoomFullError
	(*ClientJoin)(nil),                 // 7: lightspeedduel.ws.ClientJoin
	(*SpawnBot)(nil),                   // 8: lightspeedduel.ws.SpawnBot
	(*AddWaypoint)(nil),                // 9: lightspeedduel.ws.AddWaypoint
	(*UpdateWaypoint)(nil),             // 10: lightspeedduel.ws.UpdateWaypoint
	(*MoveWaypoint)(nil),               // 11: lightspeedduel.ws.MoveWaypoint
	(*DeleteWaypoint)(nil),             // 12: lightspeedduel.ws.DeleteWaypoint
	(*ClearWaypoints)(nil),             // 13: lightspeedduel.ws.ClearWaypoints
	(*ConfigureMissile)(nil),           // 14: lightspeedduel.ws.ConfigureMissile
	(*AddMissileWaypoint)(nil),         // 15: lightspeedduel.ws.AddMissileWaypoint
	(*UpdateMissileWaypointSpeed)(nil), // 16: lightspeedduel.ws.UpdateMissileWaypointSpeed
	(*MoveMissileWaypoint)(nil),        // 17: lightspeedduel.ws.MoveMissileWaypoint
	(*DeleteMissileWaypoint)(nil),      // 18: lightspeedduel.ws.DeleteMissileWaypoint
	(*ClearMissileRoute)(nil),          // 19: lightspeedduel.ws.ClearMissileRoute
	(*AddMissileRoute)(nil),            // 20: lightspeedduel.ws.AddMissileRoute
	(*RenameMissileRoute)(nil),         // 21: lightspeedduel.ws.RenameMissileRoute
	(*DeleteMissileRoute)(nil),         // 22: lightspeedduel.ws.DeleteMissileRoute
	(*SetActiveMissileRoute)(nil),      // 23: lightspeedduel.ws.SetActiveMissileRoute
	(*LaunchMissile)(nil),              // 24: lightspeedduel.ws.LaunchMissile
	(*Ghost)(nil),                      // 25: lightspeedduel.ws.Ghost
	(*Waypoint)(nil),                   // 26: lightspeedduel.ws.Waypoint
	(*RoomMeta)(nil),                   // 27: lightspeedduel.ws.RoomMeta
	(*Missile)(nil),                    // 28: lightspeedduel.ws.Missile
	(*MissileConfig)(nil),              // 29: lightspeedduel.ws.MissileConfig
	(*MissileRoute)(nil),               // 30: lightspeedduel.ws.MissileRoute
	(*ShipHeatView)(nil),               // 31: lightspeedduel.ws.ShipHeatView
	(*HeatParams)(nil),                 // 32: lightspeedduel.ws.HeatParams
	(*UpgradeEffect)(nil),              // 33: lightspeedduel.ws.UpgradeEffect
	(*PlayerCapabilities)(nil),         // 34: lightspeedduel.ws.PlayerCapabilities
	(*DagNode)(nil),                    // 35: lightspeedduel.ws.DagNode
	(*DagState)(nil),                   // 36: lightspeedduel.ws.DagState
	(*DagStart)(nil),                   // 37: lightspeedduel.ws.DagStart
	(*DagCancel)(nil),                  // 38: lightspeedduel.ws.DagCancel
	(*DagStoryAck)(nil),                // 39: lightspeedduel.ws.DagStoryAck
	(*DagList)(nil),                    // 40: lightspeedduel.ws.DagList
	(*DagListResponse)(nil),            // 41: lightspeedduel.ws.DagListResponse
	(*InventoryItem)(nil),              // 42: lightspeedduel.ws.InventoryItem
	(*Inventory)(nil),                  // 43: lightspeedduel.ws.Inventory
	(*StoryDialogueChoice)(nil),        // 44: lightspeedduel.ws.StoryDialogueChoice
	(*StoryTutorialTip)(nil),           // 45: lightspeedduel.ws.StoryTutorialTip
	(*StoryDialogue)(nil),              // 46: lightspeedduel.ws.StoryDialogue
	(*StoryEvent)(nil),                 // 47: lightspeedduel.ws.StoryEvent
	(*StoryState)(nil),                 // 48: lightspeedduel.ws.StoryState
	(*MissionSpawnWave)(nil),           // 49: lightspeedduel.ws.MissionSpawnWave
	(*MissionStoryEvent)(nil),          // 50: lightspeedduel.ws.MissionStoryEvent
	nil,                                // 51: lightspeedduel.ws.StoryState.FlagsEntry
}
var file_proto_ws_messages_proto_depIdxs = []int32{
	5,  // 0: lightspeedduel.ws.WsEnvelope.state_update:type_name -> lightspeedduel.ws.StateUpdate
	6,  // 1: lightspeedduel.ws.WsEnvelope.room_full:type_name -> lightspeedduel.ws.RoomFullError
	7,  // 2: lightspeedduel.ws.WsEnvelope.join:type_name -> lightspeedduel.ws.ClientJoin
	8,  // 3: lightspeedduel.ws.WsEnvelope.spawn_bot:type_name -> lightspeedduel.ws.SpawnBot
	9,  // 4: lightspeedduel.ws.WsEnvelope.add_waypoint:type_name -> lightspeedduel.ws.AddWaypoint
	10, // 5: lightspeedduel.ws.WsEnvelope.update_waypoint:type_name -> lightspeedduel.ws.UpdateWaypoint
	11, // 6: lightspeedduel.ws.WsEnvelope.move_waypoint:type_name -> lightspeedduel.ws.MoveWaypoint
	12, // 7: lightspeedduel.ws.WsEnvelope.delete_waypoint:type_name -> lightspeedduel.ws.DeleteWaypoint
	13, // 8: lightspeedduel.ws.WsEnvelope.clear_waypoints:type_name -> lightspeedduel.ws.ClearWaypoints
	14, // 9: lightspeedduel.ws.WsEnvelope.configure_missile:type_name -> lightspeedduel.ws.ConfigureMissile
	15, // 10: lightspeedduel.ws.WsEnvelope.add_missile_waypoint:type_name -> lightspeedduel.ws.AddMissileWaypoint
	16, // 11: lightspeedduel.ws.WsEnvelope.update_missile_waypoint_speed:type_name -> lightspeedduel.ws.UpdateMissileWaypointSpeed
	17, // 12: lightspeedduel.ws.WsEnvelope.move_missile_waypoint:type_name -> lightspeedduel.ws.MoveMissileWaypoint
	18, // 13: lightspeedduel.ws.WsEnvelope.delete_missile_waypoint:type_name -> lightspeedduel.ws.DeleteMissileWaypoint
	19, // 14: lightspeedduel.ws.WsEnvelope.clear_missile_route:type_name -> lightspeedduel.ws.ClearMissileRoute
	20, // 15: lightspeedduel.ws.WsEnvelope.add_missile_route:type_name -> lightspeedduel.ws.AddMissileRoute
	21, // 16: lightspeedduel.ws.WsEnvelope.rename_missile_route:type_name -> lightspeedduel.ws.RenameMissileRoute
	22, // 17: lightspeedduel.ws.WsEnvelope.delete_missile_route:type_name -> lightspeedduel.ws.DeleteMissileRoute
	23, // 18: lightspeedduel.ws.WsEnvelope.set_active_missile_route:type_name -> lightspeedduel.ws.SetActiveMissileRoute
	24, // 19: lightspeedduel.ws.WsEnvelope.launch_missile:type_name -> lightspeedduel.ws.LaunchMissile
	37, // 20: lightspeedduel.ws.WsEnvelope.dag_start:type_name -> lightspeedduel.ws.DagStart
	38, // 21: lightspeedduel.ws.WsEnvelope.dag_cancel:type_name -> lightspeedduel.ws.DagCancel
	39, // 22: lightspeedduel.ws.WsEnvelope.dag_story_ack:type_name -> lightspeedduel.ws.DagStoryAck
	40, // 23: lightspeedduel.ws.WsEnvelope.dag_list:type_name -> lightspeedduel.ws.DagList
	49, // 24: lightspeedduel.ws.WsEnvelope.mission_spawn_wave:type_name -> lightspeedduel.ws.MissionSpawnWave
	50, // 25: lightspeedduel.ws.WsEnvelope.mission_story_event:type_name -> lightspeedduel.ws.MissionStoryEvent
	41, // 26: lightspeedduel.ws.WsEnvelope.dag_list_response:type_name -> lightspeedduel.ws.DagListResponse
	25, // 27: lightspeedduel.ws.StateUpdate.me:type_name -> lightspeedduel.ws.Ghost
	25, // 28: lightspeedduel.ws.StateUpdate.ghosts:type_name -> lightspeedduel.ws.Ghost
	27, // 29: lightspeedduel.ws.StateUpdate.meta:type_name -> lightspeedduel.ws.RoomMeta
	28, // 30: lightspeedduel.ws.StateUpdate.missiles:type_name -> lightspeedduel.ws.Missile
	29, // 31: lightspeedduel.ws.StateUpdate.missile_config:type_name -> lightspeedduel.ws.MissileConfig
	26, // 32: lightspeedduel.ws.StateUpdate.missile_waypoints:type_name -> lightspeedduel.ws.Waypoint
	30, // 33: lightspeedduel.ws.StateUpdate.missile_routes:type_name -> lightspeedduel.ws.MissileRoute
	36, // 34: lightspeedduel.ws.StateUpdate.dag:type_name -> lightspeedduel.ws.DagState
	43, // 35: lightspeedduel.ws.StateUpdate.inventory:type_name -> lightspeedduel.ws.Inventory
	48, // 36: lightspeedduel.ws.StateUpdate.story:type_name -> lightspeedduel.ws.StoryState
	34, // 37: lightspeedduel.ws.StateUpdate.capabilities:type_name -> lightspeedduel.ws.PlayerCapabilities
	26, // 38: lightspeedduel.ws.Ghost.waypoints:type_name -> lightspeedduel.ws.Waypoint
	31, // 39: lightspeedduel.ws.Ghost.heat:type_name -> lightspeedduel.ws.ShipHeatView
	31, // 40: lightspeedduel.ws.Missile.heat:type_name -> lightspeedduel.ws.ShipHeatView
	32, // 41: lightspeedduel.ws.MissileConfig.heat_config:type_name -> lightspeedduel.ws.HeatParams
	26, // 42: lightspeedduel.ws.MissileRoute.waypoints:type_name -> lightspeedduel.ws.Waypoint
	2,  // 43: lightspeedduel.ws.UpgradeEffect.type:type_name -> lightspeedduel.ws.UpgradeEffectType
	1,  // 44: lightspeedduel.ws.DagNode.kind:type_name -> lightspeedduel.ws.DagNodeKind
	0,  // 45: lightspeedduel.ws.DagNode.status:type_name -> lightspeedduel.ws.DagNodeStatus
	33, // 46: lightspeedduel.ws.DagNode.effects:type_name -> lightspeedduel.ws.UpgradeEffect
	35, // 47: lightspeedduel.ws.DagState.nodes:type_name -> lightspeedduel.ws.DagNode
	36, // 48: lightspeedduel.ws.DagListResponse.dag:type_name -> lightspeedduel.ws.DagState
	42, // 49: lightspeedduel.ws.Inventory.items:type_name -> lightspeedduel.ws.InventoryItem
	3,  // 50: lightspeedduel.ws.StoryDialogue.intent:type_name -> lightspeedduel.ws.StoryIntent
	44, // 51: lightspeedduel.ws.StoryDialogue.choices:type_name -> lightspeedduel.ws.StoryDialogueChoice
	45, // 52: lightspeedduel.ws.StoryDialogue.tutorial_tip:type_name -> lightspeedduel.ws.StoryTutorialTip
	46, // 53: lightspeedduel.ws.StoryState.dialogue:type_name -> lightspeedduel.ws.StoryDialogue
	51, // 54: lightspeedduel.ws.StoryState.flags:type_name -> lightspeedduel.ws.StoryState.FlagsEntry
	47, // 55: lightspeedduel.ws.StoryState.recent_events:type_name -> lightspeedduel.ws.StoryEvent
