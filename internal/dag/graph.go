...
// SeedExampleGraph creates a small example graph for testing.
func SeedExampleGraph() []*Node {
	return []*Node{
		{
			ID:         "craft_basic_armor",
			Kind:       NodeKindCraft,
			Label:      "Craft Basic Armor",
			DurationS:  5.0,
			Repeatable: false,
			Payload:    map[string]string{"item": "basic_armor"},
			Requires:   []NodeID{},
		},
		{
			ID:         "craft_advanced_armor",
			Kind:       NodeKindCraft,
			Label:      "Craft Advanced Armor",
			DurationS:  10.0,
			Repeatable: false,
			Payload:    map[string]string{"item": "advanced_armor"},
			Requires:   []NodeID{"craft_basic_armor"},
		},
		{
			ID:         "upgrade_engine",
			...
			DurationS:  8.0,
			Repeatable: false,
			Payload:    map[string]string{"stat": "speed", "boost": "1.2"},
			Requires:   []NodeID{},
		},
		{
			ID:         "story_chapter_2",
			Kind:       NodeKindStoryGate,
			Label:      "Unlock Chapter 2",
			DurationS:  0.0, // Instant
			Repeatable: false,
			Payload:    map[string]string{"chapter": "2"},
			Requires:   []NodeID{"craft_basic_armor", "upgrade_engine"},
		},
		{
			ID:         "craft_repair_kit",
			Kind:       NodeKindCraft,
			...
			DurationS:  3.0,
			Repeatable: true, // Can be crafted multiple times
			Payload:    map[string]string{"item": "repair_kit"},
			Requires:   []NodeID{"craft_basic_armor"},
		},
	}
}
